...
<div class="container-fluid page-header mb-5 position-relative">
    <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
        ...
        <div class="d-inline-flex mb-lg-5">
            ...
            <p class="m-0 text-white px-2">/</p>
            <p class="m-0 text-white">Educación y Capacitación</p>
        </div>
    </div>
</div>
<!-- Page Header End -->
...
<div class="container-fluid py-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="blog-item">
                    <img class="img-fluid" src="img/education-1.jpg" alt="">
                    <div class="blog-content">
                        <h4 class="text-primary">Recursos Educativos</h4>
                        <p>Material de apoyo.</p>
                        <!-- Actualiza el enlace al controlador que lista materiales -->
                        <a href="<?php echo base_url('index.php/materialAcademico/listar_material'); ?>" class="btn btn-primary mt-3">Ver Más</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="blog-item">
                    <img class="img-fluid" src="img/education-2.jpg" alt="">
                    <div class="blog-content">
            ...
            <div class="col-lg-4">
                <div class="blog-item">
                    <img class="img-fluid" src="img/education-3.jpg" alt="">
                    <div class="blog-content">
