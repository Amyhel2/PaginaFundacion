...
|
*/
//$config['base_url'] = 'http://localhost/web3-2024/CLASE22-04-24/codeigniter/';

// la linea 29 y 30 ayuda dinamicamente a dectectar automaticamente
//$config['base_url'] = "http://".$_SERVER['HTTP_HOST'];
//$config['base_url'] .= preg_replace('@/+$@','',dirname($_SERVER['SCRIPT_NAME'])).'/';
//$config['base_url'] = "http://" . $_SERVER['HTTP_HOST'] . rtrim(dirname($_SERVER['SCRIPT_NAME']), '/') . '/';
...
$config['sess_expiration'] = 7200; /*tiempo de cierre de secion*/
