 ...
 <div class="container-fluid footer bg-secondary text-white mt-5 pt-5 px-0 position-relative">
        <div class="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>Sacaba, Calle Aroma Sud entre Amiraya y Pulacayo</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+59162684444</p>
                <p class="m-0"><i class="fa fa-envelope mr-2"></i>info@ejemplo.com</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="text-white text-uppercase mb-4" style="letter-spacing: 3px;">Síguenos en</h4>
                <p>Conéctate con nosotros en nuestras redes sociales para mantenerte al día con nuestras actividades y
                    eventos.</p>
