...
<head>
    <meta charset="utf-8">
    <title>Educacion y Capacitación</title>
...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center py-3 bg-secondary text-white">
        <div id="logo">
            <h1><a class="text-white" href="<?php echo base_url() ?>index.php/estudiante/principal">Promesa<span>Fundación 705</span></a></h1>
        </div>
        <div class="d-flex">
            <a href="<?php echo base_url() ?>index.php/usuarios/index" class="nav-item nav-link">Iniciar sesión</a>
            <a href="<?php echo base_url() ?>index.php/usuarios/index" class="nav-item nav-link">Registrarse</a>
        </div>
    </div>
</div>
<!-- Header End -->
